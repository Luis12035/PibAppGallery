<?php
    ...
    if($mydb->error){
        ...
        $body = "
        Su cuenta fue creada correctamente. Haga click en el enlace para confirmar su cuenta.
        ";
    
        send_email("lg_trocheza@unicah.edu", "Registro de cuenta", $UsrMail, "Confirmación de Cuenta", $body);
